...
function InstallationDetails() {
  ...
  const processSteps = ["install_step_1", "install_step_2", "install_step_3", "install_step_4"];
  const guarantees = ["install_guarantee_1", "install_guarantee_2", "install_guarantee_3"];
  const faqs = ["install_faq_1", "install_faq_2", "install_faq_3"];
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#0A2647] text-white py-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <p className="text-[#3ABEF9] font-semibold uppercase tracking-wider text-sm mb-3">
            {t('install_hero_kicker')}
          </p>
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {t('install_hero_title')}
          </h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0A2647] mb-2">{t('install_process_title')}</h2>
            <p className="text-gray-600 max-w-xl mx-auto">
              {t('install_process_subtitle')}
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-[#0A2647] text-white">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl font-bold text-center mb-12">{t('install_trust_title')}</h2>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold text-[#0A2647] mb-4">
            {t('install_final_cta_title')}
          </h2>
          <p className="text-gray-600 mb-8 text-lg">
            {t('install_final_cta_desc')}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
